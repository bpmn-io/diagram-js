 ...
 *
 * @param {ElementLike|ElementLike[]} elements the elements to select the children from
 * @param {boolean} unique whether to return a unique result set (no duplicates)
 * @param {number} maxDepth the depth to search through or -1 for infinite
 *
 * @return {ElementLike[]} found elements
 */
 ...
 *
 * @param {ElementLike[]} elements to query
 * @param {boolean} allowDuplicates to allow duplicates in the result set
 *
 * @return {ElementLike[]} the collected elements
 */
 ...
 *
 * @param {ElementLike|ElementLike[]} elements
 ...
 *
 * @param {ElementLike[]} elements List of Elements to search through
 * @param {Rect} bbox the enclosing bbox.
 *
 * @return {ElementLike[]} enclosed elements
 */
