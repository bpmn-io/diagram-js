 ...
 *
 * @typedef {import('./Text').Padding} Padding
 * @typedef {import('./Text').PaddingConfig} PaddingConfig
 *
 * @typedef {import('./Text').Alignment} Alignment
 * @typedef {import('./Text').AlignmentConfig} AlignmentConfig
 *
 * @typedef {import('./Text').TextConfig} TextConfig
 * @typedef {import('./Text').TextLayoutConfig} TextLayoutConfig
 *
 * @typedef {import('./Text').LineDescriptor} LineDescriptor
 */
