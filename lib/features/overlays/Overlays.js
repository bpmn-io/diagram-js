...
Overlays.prototype.get = function(search) {
  ...
  if (search.element) {
    ...
    if (container) {
      return search.type ? filter(container.overlays, function(e) { return e.type === search.type; }) : container.overlays.slice();
    } else {
      return [];
    }
  } else
  if (search.type) {
    return filter(this._overlays, function(e) { return e.type === search.type; });
  } else {
