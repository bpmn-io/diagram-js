...
/**
 * @typedef { (event: { elements: Base[] }) => Base[]|boolean } CopyPasteCanCopyElementsListener
 */

/**
 * @typedef { (event: { descriptor: any, element: Base, elements: Base[] }) => void } CopyPasteCopyElementListener
 */

/**
 * @typedef { (event: { element: Base, children: Base[] }) => void } CopyPasteCreateTreeListener
 */
