...
CopyPaste.prototype.copy = function(selectedElements) {
  ...
  forEach(tree, function(elements) {
    ...
    forEach(elements, function(element) {
      ...
      if (element.labelTarget) {
        labelTarget = find(elements, function(e) { return e.id === element.labelTarget; });
...
CopyPaste.prototype.hasRelations = function(elements, element) {
  ...
  if (element.waypoints) {
    source = find(elements, function(e) { return e.id === element.source.id; });
    target = find(elements, function(e) { return e.id === element.target.id; });
  ...
  if (element.labelTarget) {
    labelTarget = find(elements, function(e) { return e.id === element.labelTarget.id; });
...
CopyPaste.prototype.createTree = function(elements) {
  ...
  function includeElement(data) {
    var idx = findIndex(includedElements, function(e) { return e.element === data.element; }),
        element;
