 ...
 * @param {Object} context
 * @param {djs.model.Base} context.element
 * @param {Array<djs.model.Base>} context.children Push additional children you want to be copied to this array.
 */
...
CopyPaste.prototype.createTree = function(elements) {
  ...
  eachElement(parents, function(element, _index, depth) {
    ...
    if (element.children) {
      allChildren = element.children.slice();
    }

    // allow other components to add additional children
