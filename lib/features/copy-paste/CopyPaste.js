 ...
 * @param {Array<Base>} context.elements
 *
 * @returns {Array<Base>|boolean} - Return elements to be copied or false to disallow
 * copying.
 */
 ...
 * @param {Object} context
 * @param {Base} context.element
 * @param {Array<Base>} context.children - Add children to be added to tree.
 */
