 ...
 * @returns {Object}
 */
CopyPaste.prototype.copy = async function(elements) {
  var allowed,
      tree;
  ...
  // to copy was empty.
  await this._clipboard.set(tree);
...
CopyPaste.prototype.copySync = function(elements) {
  var allowed,
      tree;
 ...
 */
CopyPaste.prototype.paste = async function(context) {
  var tree = await this._clipboard.get();
