...
function PopupMenuWrapper(props) {
  ...
  const popupClassName = classNames('djs-popup', className, {
    'djs-popup--keyboard': interactionMode === 'keyboard',
    'djs-popup--pointer': interactionMode === 'pointer'
  });
  ...
  return html`
    <div
      ...
      onKeydownCapture=${ onKeyboardInteraction }
      onKeydown=${ onKeydown }
      onKeyup=${ onKeyup }
      ref=${ popupRef }
      tabIndex="-1"
