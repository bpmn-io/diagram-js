 ...
 * @typedef {import('../../i18n/translate/translate').default} translate
 *
 ...
 */
export default function PopupMenu(config, eventBus, canvas, search, translate) {
...
PopupMenu.prototype._render = function() {
  ...
  const searchPlaceholder = this._translate('Search');
