...
PopupMenu.prototype.registerProvider = function(id, priority, provider) {
  var providers = this._providers[id] = this._providers[id] || [];
  ...
  this._insertProviderByPriority(providers, provider, priority);
};
...
PopupMenu.prototype.open = function(element, id, position) {
  ...
  var entries = current.entries = this._getEntries(element, providers),
      headerEntries = current.headerEntries = this._getHeaderEntries(element, providers);
...
PopupMenu.prototype._insertProviderByPriority = function(providers, provider, priority) {
  var descriptor = {
    provider: provider,
    priority: priority
  };
  ...
  for (var i = 0; i < providers.length; i++) {
    if (providers[i].priority < priority) {
      providers.splice(i, 0, descriptor);
      return;
    }
  }
...
PopupMenu.prototype._getProviders = function(id) {
  return this._providers[id] && this._providers[id].map(function(descriptor) {
