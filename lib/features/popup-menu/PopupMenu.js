 ...
 * @constructor
 */
export default function PopupMenu(config, eventBus, canvas, diagramJSui) {
  this._eventBus = eventBus;
  this._canvas = canvas;
  this._diagramJSui = diagramJSui;
  this._current = {};
...
PopupMenu.prototype._render = function() {
  ...
  this._diagramJSui.render(this._diagramJSui.html`
      <${PopupMenuComponent}
        onClose=${ onClose }
        position=${ position }
        className=${ className }
...
PopupMenu.prototype.reset = function() {
  this._diagramJSui.render(null, this._current.container);
};
