 ...
 *
 * @example
 * contextPad.registerProvider(800, {
...
ContextPad.prototype.registerProvider = function(priority, provider) {
  ...
  this._insertProviderByPriority(provider, priority);
};
...
ContextPad.prototype._insertProviderByPriority = function(provider, priority) {
...
ContextPad.prototype._getProviders = function(id) {
  return this._providers.map(function(descriptor) {
