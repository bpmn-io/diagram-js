...
/**
 * @typedef {Element|Element[]} ContextPadTarget
 *
 * @typedef { {
 *   action: Function;
 *   label: string;
 * } } ContextPadEntry
 *
 * @typedef {Record<string, ContextPadEntry>} ContextPadEntries
 *
 * @typedef {(entries: ContextPadEntries) => ContextPadEntries} ContextPadProviderCallback
 *
 * @typedef { {
 *   getContextPadEntries: (element: Element) => ContextPadProviderCallback | ContextPadEntries
 *   getMultiElementContextPadEntries?: (elements: Element[]) => ContextPadProviderCallback | ContextPadEntries
 * } } ContextPadProvider
 *
