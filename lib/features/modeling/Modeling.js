 ...
 * Create a connection.
 *
 * @param {Base} source of the connection.
 * @param {Base} target of the connection.
 * @param {number} [parentIndex] index at which to add the connection
 * @param {Partial<Connection>} connection to be created
 * @param {Parent} parent
 * @param {ModelingHints} [hints]
 *
 ...
 * @overlord
 *
 * @param {Partial<Shape>} shape The shape to be created or its attributes.
 ...
 * @param {Point} position The position at which to create the shape.
 * @param {Parent} target The parent of the shape.
 * @param {number} [parentIndex] The optional index at which to add the shape to its parent's children.
 * @param {ModelingCreateShapeHints} [hints] The optional hints.
 *
 * @return {Shape} The created shape.
 */
 ...
 * Create elements.
 *
 * @param {(Partial<Base>)[]} elements The elements to be created or their
 * attributes.
 ...
 * @param {Partial<Label>} label The label to be created or its
 * attributes.
 ...
 * @param {Partial<Shape>} shape The shape to be created or its
 * attributes.
 * @param {Point} position The position at which to create the shape.
 * @param {Parent} target The parent of the shape.
 * @param {ModelingHints} [hints] The optional hints.
 ...
 * @param {Partial<Shape>} newShape The shape to replace with or its
 * attributes.
 * @param {ModelingHints} [hints] The optional hints.
 *
 ...
 *
 * @param {Shape} shape
 * @param {Rect} newBounds to resize to
 * @param {Dimensions} [minBounds] for resize operation
 * @param {ModelingHints} [hints]
 */
 ...
 * @param {Base} source
 * @param {Base} target
 * @param {Point|Point[]} dockingOrPoints The point to connect to or updated waypoints.
 * @param {ModelingHints} [hints]
 */
 ...
 *
 * @param {Connection} connection
 * @param {Base} newTarget
 * @param {Point|Point[]} dockingOrPoints The point to connect or the waypoints
 * @param {ModelingHints} [hints]
 */
