 ...
 * } } PaletteEntry
 *
 * @typedef {Record<string, PaletteEntry>} PaletteEntries
 *
 * @typedef {(entries: PaletteEntries) => PaletteEntries} PaletteProviderCallback
 *
 * @typedef { {
 *   getPaletteEntries: () => PaletteProviderCallback | PaletteEntries;
 * } } PaletteProvider
 */
