...
SpaceTool.prototype.init = function(event, context) {
  ...
  var spaceToolConstraints = getSpaceToolConstraints(elements, axis, delta, direction, start);
...
function getSpaceToolConstraints(elements, axis, delta, direction, start) {
