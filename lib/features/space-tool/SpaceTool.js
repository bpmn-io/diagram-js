...
import { getBBox, selfAndAllChildren } from '../../util/Elements.js';

import { getDirection } from './SpaceUtil.js';
...
import { set as setCursor } from '../../util/Cursor.js';
 ...
 * @typedef {import('../mouse/Mouse.js').default} Mouse
 * @typedef {import('../rules/Rules.js').default} Rules
 * @typedef {import('../tool-manager/ToolManager.js').default} ToolManager
 *
...
export default function SpaceTool(
  ...
  this._mouse = injector.get('mouse', false);
