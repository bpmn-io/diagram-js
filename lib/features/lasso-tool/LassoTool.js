...
import {
  getEnclosedElements as _getEnclosedElements
} from '../../util/Elements';
  ...
  */
  var visuals = {
    ...
    update: function(context) {
      ...
      var enclosed = getEnclosedElements(bbox);
   ...
   * @return {Set<Element>}
   */
  function getEnclosedElements(bbox) {

    var allElements = elementRegistry.getAll();

    return new Set(
      values(_getEnclosedElements(allElements, bbox))
    );
  }
...
LassoTool.prototype.select = function(elements, bbox, previousSelection = []) {
  var selectedElements = values(_getEnclosedElements(elements, bbox));
