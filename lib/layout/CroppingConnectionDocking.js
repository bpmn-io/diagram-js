 ...
 */
CroppingConnectionDocking.prototype.getDockingPoint = function(connection, shape, cropStart) {
  ...
  dockingIdx = cropStart ? 0 : waypoints.length - 1;
  dockingPoint = waypoints[dockingIdx];

  croppedPoint = this._getIntersection(shape, connection, cropStart);
