 ...
 */
export default function TextLayouter(config) {
...
TextLayouter.$inject = [ 'config.textLayouter' ];
 ...
 * @return {SVGElement}
 */
TextLayouter.prototype.createText = function(text, options) {
 ...
 * @return {Dimensions}
 */
TextLayouter.prototype.getDimensions = function(text, options) {
 ...
 * } }
 */
TextLayouter.prototype.layoutText = function(text, options) {
