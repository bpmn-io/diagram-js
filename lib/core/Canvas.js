...
*
* @param {boolean} [onlyFromBody=true] If true, will only focus canvas if
*     current active element is `document.body`. True by default.
*/
Canvas.prototype.focus = function(onlyFromBody = true) {
  if (!onlyFromBody || document.activeElement === document.body) {
