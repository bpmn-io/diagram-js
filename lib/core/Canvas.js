...
Canvas.prototype._setRoot = function(rootElement, layer) {
  ...
  this._eventBus.fire('root.set.start', { element: currentRoot });
  ...
  selfAndAllChildren(rootElement).forEach(function(e) {
    ...
    // update its visual
    var type = e.__type,
        gfx = elementRegistry.getGraphics(e);

    var promise = graphicsFactory.update(type, e, gfx).then(() => {
      eventBus.fire(type + '.rendered', { element: e, gfx: gfx });
    });
