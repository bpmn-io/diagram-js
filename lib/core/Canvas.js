 ...
 * @overlord
 *
 * Set zoom of the canvas to fit the current viewport. Optionally center the diagram.
 *
 * @param {'fit-viewport'} newScale
 * @param {boolean} [center] Should the canvas be centered.
 *
