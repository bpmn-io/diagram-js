...
* `FIX`: do no allow create if no hover available ([`679ef35`](https://github.com/bpmn-io/diagram-js/commit/679ef351ceb215de30230fea81983fc5f8b66ba0))
* `FIX`: relayout loops if necessary ([`3a63db0`](https://github.com/bpmn-io/diagram-js/commit/3a63db0dded35167c55e0cf9d1f0a295c3d3216b))
* `FIX`: set create target on hover events ([`d31bd00`](https://github.com/bpmn-io/diagram-js/commit/d31bd00b2a96bcae3de1f91c8733a038f37c2d88))
* `CHORE`: make it easier to override Palette container ([`f765c81`](https://github.com/bpmn-io/diagram-js/commit/f765c81a1d6d9e0983cb4b22a4de723b386df640))
